...
@Component({
  ...
  template: `
    @if (principle()) {
      <a routerLink="/reactive" class="back-link">← Back to Reactive Principles</a>
      ...
      @if (principle()!.exampleTs || principle()!.exampleHtml) {
        <section class="detail-examples">
          ...
          <p class="hint">
            Try dropping this into a standalone component/service and wire it to a simple route
            to see the reactive behavior in action.
          </p>
        </section>
      }
    } @else {
