export type GraspCategory =
  | 'Assignment'
  | 'Coupling & Cohesion'
  | 'Protection & Indirection';

export interface GraspPattern {
  id: string;
  name: string;
...
import graspPatterns from './grasp-patterns.json';

export const GRASP_PATTERNS = graspPatterns.map(pattern => ({
  ...pattern,
  exampleTs: pattern.exampleTs?.join('\n'),
}));


// export const GRASP_PATTERNS: GraspPattern[] = [
//   {
...
//     description:
//       'In Angular, services that own data (like repositories or stores) are natural “Information Experts” for operations that compute or transform that data.',
//     exampleTs: `
...
//     description:
//       'Components or services that aggregate other entities are good candidates to create them, instead of constructing them in random places.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'An Angular component, façade, or dedicated “UseCase” service can act as a GRASP Controller that coordinates calls to domain objects and services.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'Angular encourages low coupling via DI: components depend on abstractions (interfaces/services) instead of concrete implementations or global state.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'A cohesive Angular service or component has a narrow, focused purpose (e.g., “auth”, “cart”, “order-summary”) instead of mixing unrelated concerns.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'With Angular DI and TypeScript interfaces, you can vary behavior (e.g., payment or logging) by injecting different implementations.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'Repositories, facades, and mappers in Angular are classic examples of Pure Fabrication: invented classes that improve reuse and structure.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'Mediator or facade services in Angular are forms of indirection: components talk to a single intermediary instead of being coupled to each other or to many services.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
...
//     description:
//       'In Angular, you can protect components from API changes by exposing stable services and interfaces, adapting external changes behind those boundaries.',
//     exampleTs: `
// import { Injectable } from '@angular/core';
