...
export const FRONTEND_ARCH_PRINCIPLES: FrontendArchPrinciple[] = [
  {
    ...
    description:
      'In Angular, parent components pass data down via @Input() or selectors, while child components emit events via @Output() or store actions, making the flow easy to reason about.',
    exampleTs: `
...
export class TodoListComponent {
  ...
  },
  {
    ...
    description:
      'Avoid duplicating the same state in multiple services or components; instead, centralize it (e.g., in a facade or store) and derive everything else from there.',
    exampleTs: `
...
export class AuthStore {
  ...
  },
  {
    ...
    description:
      'Use component-local state for purely local concerns, feature stores for feature-wide state, and global stores only for truly global concerns.',
    exampleTs: `
...
export class TabsComponent {
  ...
  },
  {
    ...
    description:
      'Smart components own data loading, orchestration, and navigation, while dumb components receive data and emit events, staying purely presentational.',
    exampleTs: `
import { Component } from '@angular/core';
...
export class UsersContainerComponent {
  ...
  },
  {
    ...
    description:
      'Organize Angular apps into feature folders/libraries (auth, orders, dashboard) and expose only facades/public services, keeping internals private.',
    exampleTs: `
