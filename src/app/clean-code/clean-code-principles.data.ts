...
export const CLEAN_CODE_PRINCIPLES: CleanCodePrinciple[] = [
  {
    ...
    description:
      'In Angular, DRY means extracting repeated logic into shared components, directives, pipes, or services instead of copying it across templates and classes.',
    exampleTs: `
...
<p>Updated: {{ updatedAt | friendlyDate }}</p>
  ...
  },
  {
    ...
    description:
      'Angular components and services should be easy to read; avoid clever abstractions and meta-programming when a simple implementation will do.',
    exampleTs: `
...
export class CounterSimpleComponent {
  ...
  },
  {
    ...
    description:
      'Avoid adding global stores, complex caching, or generic abstractions before a real requirement exists; start simple and refactor when necessary.',
    exampleTs: `
...
export class FeatureToggleService {
  ...
  },
  {
    ...
    description:
      'Angular components should call their own injected services, not deeply nested objects (e.g., `service.a.b.c()`); introduce façade services instead.',
    exampleTs: `
import { Injectable } from '@angular/core';
...
export class OrdersFacade {
  ...
  },
  {
    ...
    description:
      'Using immutable objects works great with OnPush change detection and avoids accidental shared mutations in Angular apps.',
    exampleTs: `
