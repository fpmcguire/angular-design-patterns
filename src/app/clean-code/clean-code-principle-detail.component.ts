...
@Component({
  ...
  template: `
    @if (principle()) {
      <a routerLink="/clean-code" class="back-link">← Back to Clean Code</a>
  ...
  styles: [`
    ...
    .detail-description {
      margin: 0 0 1.25rem; max-width: 48rem;
      color: #4b5563; line-height: 1.4;
    }
    .detail-examples h3 { margin-top: 0; font-size: 1.1rem; }
    .code-block {
      margin-bottom: .75rem; border-radius: .75rem;
      border: 1px solid #e5e7eb; background: #111827; color: #e5e7eb;
      overflow: auto; box-shadow: 0 1px 4px rgba(15,23,42,.4);
    }
    .code-block__label {
